...
from src.infrastructure.fastapi.routers.vendedor import vendedor_get, vendedor_list
...
def test_get_vendedores_returns_wrapper():
    ...
    gateway_provider.vendedor_gateway = InMemoryVendedorGateway()
...
def test_get_vendedores_route_returns_502_on_gateway_error(monkeypatch):
    monkeypatch.setenv("IS_PROD", "false")
    gateway_provider.vendedor_gateway = object()
    monkeypatch.setattr(
